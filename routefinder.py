...
def a_star(start_state, heuristic_fn, goal_test, use_closed_list=True) :
    map = map_state()
    start = map_state(start_state, None, 0, sld(start_state))
    ...
    map.mars_graph = read_mars_graph("marsmap.txt")
    search_queue.put(start)
    print(map.mars_graph)
...
a_star("8,8", sld, goal_test, use_closed_list=True)